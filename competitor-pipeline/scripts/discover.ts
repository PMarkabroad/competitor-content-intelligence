...
- "adjacent": a genuine professional-services business that isn't itself career coaching but sits right next to it -- e.g. a job board or recruiter, a study-abroad or credential-recognition service that includes job placement, or a niche professional-skills trainer whose primary offer is employability (LinkedIn optimization, personal branding for job seekers). Worth a human's second look, not an automatic yes. Do NOT use this as a catch-all for "loosely related to abroad or professional life" -- if the account doesn't have a specific, named professional-services offer, it belongs in "irrelevant" instead.
- "irrelevant": everything without a genuine career-coaching or adjacent-professional-services angle. This explicitly includes: general lifestyle, travel, moving/relocation/apartment-hunting vlogs, entertainment, fitness, or personal-diary content that happens to mention living/working abroad; test-prep or language-learning content (e.g. IELTS) with no job-search framing; general motivational, mindset, or self-development content; general business, startup, or entrepreneurship advice that isn't specifically about landing a job. These stay "irrelevant" even when the account occasionally references careers, jobs, or professional growth in passing -- the test is whether that's the account's actual offer, not whether the word appears.
